// Generated by Discord++'s Plugin Native Gen: last commit a08913b on 2023-02-24 09:04:06-06:00
// https://github.com/DiscordPP/plugin-native-gen

// Based on JSON of Discord's API: commit 4a3603e on 2023-02-25 13:01:38-06:00
// https://github.com/DiscordPP/discord-api-json

// Parsed by Discord++'s parser: commit 121828a on 2023-02-25 13:01:46-06:00
// https://github.com/DiscordPP/discord-api-parser

// From Discord's official API docs: commit 111e0bd on 2023-02-24 20:31:17-05:00
...
class ActionMetadata{
  public:
    ActionMetadata(
        ...
        omittable_field<std::string> custom_message = omitted
    ):
        channel_id(channel_id),
    ...
    omittable_field<std::string> custom_message;
    ...
    friend void to_json(nlohmann::json &j, const ActionMetadata &t) {
        ...
        if(!t.custom_message.is_omitted()) {j["custom_message"] = t.custom_message;}
    }
    friend void from_json(const nlohmann::json &j, ActionMetadata &t) {
        ...
        if(j.contains("custom_message")){j.at("custom_message").get_to(t.custom_message);}
    }
};
...
class ForumThreadMessageParams{
  public:
    ForumThreadMessageParams(
        ...
        flags(flags)
    {}
    ForumThreadMessageParams(const json &j) { from_json(j, *this); }
